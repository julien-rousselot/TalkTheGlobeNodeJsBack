...
router.put('/material/:id', auth_1.authenticateToken, auth_1.requireAdmin, upload_1.upload.fields([{ name: 'cover', maxCount: 1 }, { name: 'pictures', maxCount: 10 }, { name: 'pdf', maxCount: 1 }]), materialController_1.updateMaterial);
